  ...
  return (
    <div className="h-full relative">
      ...
      <div className="flex h-full flex-col lg:flex-row ">
        ...
        <div className="p-20  md:h-full lg:w-1/2">
          <div className="lg:w-4/5 h-full rounded-md shadow-lg shadow-black bg-amber-100">
            <img
              src={profileImg}
              alt="profile"
        ...
        <div className="lg:w-1/2 p-10 lg:p-0 bg-black lg:bg-transparent">
